...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <button hx-post="{{ route('instalar_docker', [$grupo_id, $servidor['id']]) }}" hx-target="#response" hx-indicator="#spinner" class="btn btn-primary">Revisar si docker esta instalado</button>

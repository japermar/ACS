...
<div class="page-wrapper">
        ...
        <div class="main-container">
            <div class="w-layout-grid grid_1-2">
                <div id="w-node-_05440e2b-310f-d781-83e6-e169aaed84f6-2c4ffd25" class="content-wrap">
                    ...
                    <div class="spacer_xs"></div>
                    <p class="paragraph">ACS (Auto configuracion de sistemas) es una novedosa idea donde podras administrar tu VPS de una forma grafica comoda e intuitia sin necesidad de recordar comandos.</p>
    ...
    <div class="main-section">
        <div class="main-container">
            <div class="w-layout-grid grid_1-2">
                <div id="w-node-_9a521c9b-b9ee-4177-6591-f2e194d4a0fd-2c4ffd25" class="content-wrap"><h2 class="h2">Hecha para todo tipo de pantallas</h2>
                    <div class="spacer_m"></div>
                    <p class="paragraph">Con nuestro servicio puedes configurar un VPS desde el movil gracias a la sencillez grafica.</p>
                    <div class="spacer_l"></div>
                 </div>
    ...
    <div id="about" class="main-section">
        <div class="main-container">
            <div class="w-layout-grid grid_1-2 reverse"><img src="{{asset('img/ssh.png')}}"
                ...
                <div id="w-node-b4ef11d3-2ae9-1808-aaa2-cbc9973a0fbc-2c4ffd25" class="content-wrap"><h2 class="h2">Tenemos un gran objetivo</h2>
                    <div class="spacer_m"></div>
                    <p class="paragraph">Nuestro objetivo es conseguir que el despliegue de aplicaciones web o configuraciones de servidores sea lo mas comoda y facil posible .</p>
                    <div class="spacer_l"></div>
        ...
        <div class="main-container">
            <div class="w-layout-grid grid_1-2 _75-space">
                <div id="w-node-_896be899-d6d5-78ce-59df-eb1d6476f4e1-2c4ffd25"
                    ...
                    <div class="spacer_m"></div>
                    <p class="paragraph">Queremos que ACS sea un sistema completo a la hora de desplegar para no tener que utilizar otras herramientas.</p>
                    <div class="spacer_l"></div>
                   </div>
                <div id="w-node-_896be899-d6d5-78ce-59df-eb1d6476f4ea-2c4ffd25" class="w-layout-grid grid_2-2">
                    <div id="w-node-_896be899-d6d5-78ce-59df-eb1d6476f4eb-2c4ffd25"
                        ...
                        <div class="spacer_xs"></div>
                        <p class="paragraph">ACS se centra en ser rapido y ligero para llevar a cabo una tarea lo mas rapido posible.</p></div>
                    <div id="w-node-_896be899-d6d5-78ce-59df-eb1d6476f4f6-2c4ffd25"
                        ...
                        <div class="spacer_xs"></div>
                        <p class="paragraph">La sencillez visual permite mejorar la concentracion a la hora de configurar un VPS.</p></div>
                    <div id="w-node-_896be899-d6d5-78ce-59df-eb1d6476f501-2c4ffd25"
                        ...
                        <div class="spacer_xs"></div>
                        <p class="paragraph">Minimiza los costos operativos y el consumo de recursos gracias a una gestión eficiente, automatizada y optimizada de tus servidores.</p></div>
                    <div id="w-node-_896be899-d6d5-78ce-59df-eb1d6476f50c-2c4ffd25"
                        ...
                        <div class="spacer_xs"></div>
                        <p class="paragraph">Imagina tener un asistente personal que no solo entiende tus necesidades sino que también ofrece soluciones proactivas, gracias a la integración con la API de OpenAI.</p></div>
                </div>
            </div>
        </div>
    </div>
